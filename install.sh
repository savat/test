#!/bin/bash
rm -f install.sh
scrip="https://raw.githubusercontent.com/savat/test/master/"
clear
cd /usr/bin
...
wget -q -O /usr/bin/pass https://raw.githubusercontent.com/savat/test/master/pass.txt
